...
/**
 * Base abstract class for arrays that implement sorting algorithms.
 * @abstract
...
export class AbstractSortArray extends ScopeArray {
   ...
   * @param {module:sort/abstract~Entry[]} entries - An array of index / value pairs of elements involved in the step.
   */

  /**
   * Creates an AbstractSortArray. Do not invoke directly.
