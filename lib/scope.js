 ...
 * @interface module:sort/scope.Scope
 */

/**
 * @method
 * @name module:sort/scope.Scope#has
...
/**
 * @method
 * @name module:sort/scope.Scope#delete
 * @param {*} key - Reference key of scoped variable.
...
/**
 * @method
 * @name module:sort/scope.Scope#get
 * @param {*} key - Reference key of scoped variable.
...
/**
 * @method
 * @name module:sort/scope.Scope#set
 * @param {*} key - Reference key of scoped variable.
 ...
 * @extends Array
 * @implements {module:sort/scope.Scope}
 */
