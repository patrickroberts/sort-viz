...
export class ShellSortArray extends ComparativeSortArray {
   ...
   * @param {number} length
   * @param {module:sort/comparative/shell~sequenceCallback} gaps
   * @yield {number}
   */
  ...
  /**
   * @param {module:sort/abstract~interruptCallback} interrupt
   * @param {module:sort/comparative~compareCallback} compare
   * @param {iterable|module:sort/comparative/shell~sequenceCallback} sequence - If an `iterable` is passed, it is converted to a `sequenceCallback`.
