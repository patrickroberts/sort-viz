 ...
 * @param {iterable|module:sort/virtual.sequenceCallback} [sequence=module:sort/comparative/shell.ShellSortArray.tokuda] - If an `iterable` is passed, it is converted to a `sequenceCallback`.
 *
